                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="logincheck.php">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputEmail" name="username" required type="text" placeholder="" />
                                                <label for="inputEmail">Username</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputPassword" name="password" required type="password" placeholder="" />
                                    ...
                                    -->
                                    <?php if($session->check('login_error')){ ?>
                                    <div class="card-footer text-center py-3 text-danger">
                                       <?php echo $session->get('login_error', true);?>
                                    </div>
                                    <?php } ?>
                                </div>
                            </div>
